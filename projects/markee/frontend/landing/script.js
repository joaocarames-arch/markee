...
const i18n = {
  "pt": {
    ...
    "nav.features": "Serviços",
    "nav.engine": "Começar",
    "nav.pricing": "FAQ",
    "nav.login": "Entrar",
    "nav.create": "Criar conta",
    "nav.service_status": "Estado do serviço",
    "hero.eyebrow": "SERVIÇOS PROFISSIONAIS DE MARCA UE",
    "hero.title": "Proteção de marcas UE, mais simples.",
    "hero.title.line1": "Proteção de marcas UE,",
    "hero.title.line2": "<em class=\"hero__title-accent\">mais simples.</em>",
    "hero.title.line3": "Pesquisar. Registar. Proteger.",
    "hero.subtitle": "A Markee é uma firma de serviços profissionais de marcas UE que combina pesquisa, registo e proteção com competência profissional e tecnologia proprietária.",
    ...
    "nav.monitoring": "Proteção",
    "nav.renewals": "Níveis de apoio",
    "nav.about": "Confiança",
  ...
  "en": {
    ...
    "nav.engine": "Start here",
    "nav.pricing": "FAQ",
    "nav.login": "Client Area",
    "nav.create": "Create account",
    "nav.service_status": "Service status",
    "hero.eyebrow": "PROFESSIONAL EU TRADEMARK SERVICES",
    "hero.title": "EU trademark protection, made simpler.",
    "hero.title.line1": "EU trademark protection,",
    "hero.title.line2": "<em class=\"hero__title-accent\">made simpler.</em>",
    "hero.title.line3": "Search. Register. Protect.",
    "hero.subtitle": "Markee is a professional EU trademark services firm combining search, registration and protection with professional expertise and proprietary technology.",
    ...
    "features.eyebrow": "CUSTOMER JOURNEY",
    "features.title": "Search → Understand → Expert Review → Register → Monitor",
    "feature.sim.title": "Check",
    ...
    "nav.monitoring": "Protection",
    "nav.renewals": "Support levels",
    "nav.about": "Trust",
