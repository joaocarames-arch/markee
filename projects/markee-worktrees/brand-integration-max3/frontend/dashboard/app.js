    ...
    <div class="shell">
      <aside class="sidebar${state.sidebarOpen ? ' open' : ''}" id="sidebar" aria-label="Navegação principal">
        <div class="sidebar-brand">
          <img class="wordmark" src="/assets/brand-v2/logos/markee-wordmark-dark.svg" alt="markee" width="124" height="20">
        </div>
  ...
  root.innerHTML = `
    <div class="auth-wrap">
      <div class="glass-card auth-card">
        <div class="auth-brand"><img class="wordmark" src="/assets/brand-v2/logos/markee-wordmark-dark.svg" alt="markee" width="173" height="28"></div>
        <p class="auth-sub">Monitorização de marcas no INPI e EUIPO</p>
...
function renderSearch() {
  ...
  view.innerHTML = `
    ...
    <div id="search-results">
      ${renderEmpty('Pesquise por uma marca…', 'Introduza um termo para procurar marcas no EUIPO e INPI.', 'search')}
    </div>`;
