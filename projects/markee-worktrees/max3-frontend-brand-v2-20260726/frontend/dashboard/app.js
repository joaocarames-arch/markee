    ...
    <div class="shell">
      <aside class="sidebar${state.sidebarOpen ? ' open' : ''}" id="sidebar" aria-label="Navegação principal">
        <div class="sidebar-brand">
          <img class="dashboard-wordmark" src="/assets/brand-v2/logos/markee-wordmark-dark.svg" alt="markee" />
        </div>
  ...
  root.innerHTML = `
    <div class="auth-wrap">
      <div class="glass-card auth-card">
        <div class="auth-brand"><img class="dashboard-wordmark" src="/assets/brand-v2/logos/markee-wordmark-dark.svg" alt="markee" /></div>
