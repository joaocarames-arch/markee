...
class TestBPIEventIngestion:
    ...
    def _enable_bpi_ingestion(self, monkeypatch):
        """These tests exercise the ingestion mechanics themselves; the
        default-off containment gate is covered in ``tests/stg00/``."""
