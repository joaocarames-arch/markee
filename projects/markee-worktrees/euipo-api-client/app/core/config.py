...
class Settings(BaseSettings):
    ...
    # ── EUIPO Trademark Search API 1.1.0 ────────────────────────────────────
    # The new offline client foundation is fail-closed and not wired to jobs/UI.
    # Credentials are separate per EUIPO portal and selected by EUIPO_ENVIRONMENT.
    EUIPO_ENABLED: bool = False
    EUIPO_ENVIRONMENT: str = "sandbox"
    EUIPO_CLIENT_ID_SANDBOX: str = ""
    EUIPO_CLIENT_SECRET_SANDBOX: str = ""
    EUIPO_CLIENT_ID_PROD: str = ""
    EUIPO_CLIENT_SECRET_PROD: str = ""
    EUIPO_INCREMENTAL_OVERLAP_DAYS: int = 1

    # Legacy service settings retained until its runtime wiring is replaced.
